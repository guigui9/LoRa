...
void do_send(osjob_t* j){
    ...
    if (LMIC.opmode & OP_TXRXPEND) {
        ...
        floatToStr (getSinus ()); LMIC_setTxData2(1, mydata, strlen ((char*)mydata), 0);
...
void setup() {
    ...
    LMIC_setDrTxpow(DR_SF9,14); LMIC_disableChannel (1); LMIC_disableChannel (2);
...
void floatToStr (float f) {
  ...
  for (uint8_t *c = &mydata[strlen ((char*)mydata) - 1]; *c == ' '; *c-- = 0);  // rtrim
}
